...
class Poem(db.Model):
    ...
    description = db.Column(db.String(255))  # Descripción breve del poema
    content = db.Column(db.Text, nullable=False)  # Contenido del poema
    ...
    def to_json(self):
        poem_json = {
            ...
            "author_name": f"{self.author.firstname} {self.author.lastname}",  
            "author_image_url": self.author.image_url if self.author.image_url else None, 
            "genre": self.genre,
